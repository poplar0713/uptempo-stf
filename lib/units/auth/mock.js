      ...
      case 'json':
        requtil.validate(req, function() {
          ...
          .then(function() {
            ...
            if (req.body.email == "test@test.com" || req.body.email == "test2@test.com" && req.body.name == "test") {
	       ...
	       res.status(400).json({success: false, error: 'ValidationError', validationErrors: err.errors})
	     }
