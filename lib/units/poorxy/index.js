...
module.exports = function(options) {
  ...
  ;['/static/auth/*', '/auth/*'].forEach(function(route) {
    let corsOption = {
      'origin': ['http://61.74.187.4:3000', 'http://localhost:3000', 'http://61.74.187.4', 'http://61.74.187.24:3000', 'http://61.74.187.24', 'http://up-tempo.ktds.com', 'http://dev.up-tempo.ktds.com'],
      'credentials': true
    }
  ...
  let corsOption = {
    'origin': ['http://61.74.187.4:3000', 'http://61.74.187.4', 'http://61.74.187.24:3000', 'http://61.74.187.24', 'http://up-tempo.ktds.com', 'http://dev.up-tempo.ktds.com'],
    'credentials': true
  }
  app.use(cors(corsOption))
